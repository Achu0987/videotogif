...
export default function Header({ activeTab, setActiveTab }) {
  return (
    <header className="w-full flex items-center justify-between px-8 py-4 bg-white/80 backdrop-blur-md border-b border-gray-100 font-sans z-50 sticky top-0 transition-all">
      {/* Left: Logo Area */}
      <div 
        className="flex items-center gap-3 cursor-pointer w-48 shrink-0"
      ...
      <div className="hidden md:flex items-center bg-[#f4f4f5] rounded-full p-1.5 shadow-inner">
        <button 
          onClick={() => setActiveTab('home')}
      ...
      <div className="flex items-center justify-end gap-4 w-48 shrink-0">
        <button className="w-10 h-10 rounded-full bg-[#f4f4f5] flex items-center justify-center text-gray-600 hover:bg-gray-200 hover:text-gray-900 transition-colors">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />
          </svg>
        </button>
        <button className="px-6 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-sm transition-all shadow-[0_4px_14px_rgba(79,70,229,0.39)] hover:shadow-[0_6px_20px_rgba(79,70,229,0.23)] transform hover:-translate-y-0.5">
          Sign In
        </button>
      </div>
    </header>
